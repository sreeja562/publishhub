...
export default function ArticlePage() {
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="mx-auto flex min-h-[70vh] max-w-4xl flex-col items-center justify-center px-5 text-center">
          ...
          <Link
            href="/articles"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-black px-6 py-3 text-sm font-medium text-white"
          >
            <ArrowLeft size={16} />
            Back to Articles
          </Link>
  ...
  const handleAddComment = () => {
    ...
    const newComment = addComment(article.id, text, article.author);
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="bg-white">
        ...
        <div className="mx-auto max-w-4xl px-5 pb-10 pt-12 md:pt-16">
          ...
          <p className="mt-8 text-xs font-semibold uppercase tracking-[0.25em] text-blue-600">
            {article.category}
          </p>
